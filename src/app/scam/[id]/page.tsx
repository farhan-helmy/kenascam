    ...
    <div>
      <Card>
        ...
        <CardContent className="flex flex-col gap-2">
          ...
          <button className="flex justify-end pr-1 text-end" onClick={() => comment()}>
  ...
  return (
    <div className="md:grid md:grid-cols-3 lg:grid lg:grid-cols-3 xl:grid xl:grid-cols-3">
      ...
      <div className="flex flex-col p-4">
        ...
        <div className="pt-4">
          <CommentSection comments={scam.data?.comments as Comments[]} scamID={params.id} refetch={scam.refetch} />
        </div>
      </div>
    </div>
  );
